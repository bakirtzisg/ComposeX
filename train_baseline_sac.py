...
if __name__ == "__main__":
    ...
    for step in range(TOTAL_TRAINING_STEPS):
        ...
        actions, buffer_actions = sac_agent._sample_action(
            sac_agent.learning_starts, sac_agent.action_noise, sac_agent.env.num_envs
        )
        ...
        sac_agent._store_transition(
            sac_agent.replay_buffer, buffer_actions, new_obs, rewards, dones, infos
        )

        sac_agent._update_current_progress_remaining(
            sac_agent.num_timesteps, sac_agent._total_timesteps
        )
        ...
        for idx, done in enumerate(dones):
            if done:
                ...
                if (
                    ...
                    and sac_agent._episode_num % LOG_INTERVAL == 0
                ):
